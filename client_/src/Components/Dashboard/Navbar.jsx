    ...
    <nav className="border-gray-200 bg-gray-50 dark:bg-gray-800  h-16  flex items-center  shadow">
      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-end mx-auto ">
        <div className="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
          <ul className="flex flex-col w-full items-center justify-center  font-medium mt-4 rounded-lg bg-gray-50 md:flex-row md:space-x-72 md:mt-0 md:border-0 md:bg-transparent ">
            <li className="flex gap-6 items-center w-full">
              <div className="flex items-center gap-1 justify-start w-full">
                <div className=" h-10 w-10 shadow hover:opacity-60  duration-100 transition-all border-2  p-1  rounded-full text-white font-semibold flex items-center justify-center  cursor-pointer select-none">
                  <div
                    style={{
                      backgroundColor: getRandomColorName(
                        firstLetter,
                        secondLetter
                      ),
                    }}
                ...
                <a
                  href="#"
                  title="User"
                  className="flex ml-1 justify-start w-full items-center gap-1 py-2 pl-3 pr-4  bg-blue-700 rounded md:bg-transparent text-black md:p-0 md:dark:text-blue-500 dark:bg-blue-600 md:dark:bg-transparent"
                  aria-current="page"
                >
            ...
            <li
              className="flex justify-end py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500 dark:bg-blue-600 md:dark:bg-transparent"
              aria-current="page"
            >
              <FontAwesomeIcon
                onClick={logout}
